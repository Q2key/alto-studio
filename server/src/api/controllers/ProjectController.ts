...
export class ProjectController extends BaseController {
    ...
    public FindAll = async (req: TRequestBody<{}>, res: TResponse<{ projects: IProjectDto[] }>, next: NextFunction): Promise<TResponse<{ projects: IProjectDto[] }>> => {
    ...
    public Create = async (req: TRequestBody<IProjectInput>, res: TResponse<{ project: IProjectDto }>, next: NextFunction): Promise<TResponse<{ project: IProjectDto }>> => {
        return this.wrap(async () => {
