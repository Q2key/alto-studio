...
export class UserController extends BaseController {
    ...
    public FindAll = async (req: TRequestBody<{}>, res: TResponse<{ users: IUserDto[] }>, next: NextFunction): Promise<TResponse<{ users: IUserDto[] }>> => {
    ...
    public Create = async (req: TRequestBody<ICreateUserInput>, res: TResponse<{ user: IUserDto }>, next: NextFunction): Promise<TResponse<{ user: IUserDto }>> => {
        return this.wrap(async () => {
